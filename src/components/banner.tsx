      ...
      >
        {banners.map((banner, index) => (
          ...
          >
            ...
            />
            <figcaption className="md:block absolute top-1/2 py-2 px-2 md:pl-8 md:pr-5 md:pt-9 w-[190px] h-[140px] md:w-[360px] md:h-[280px] right-6 md:right-12 lg:w-[623px] lg:h-[423px] rounded-xl bg-[#FFF3E3] transform -translate-y-1/2">
